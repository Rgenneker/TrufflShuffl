          ...
          {nwResult && (
            <div className="grid grid-cols-3 gap-3">
              <div className="bg-background rounded-lg p-4 border border-green-500/30 text-center">
                ...
                <p className="font-mono text-lg font-bold text-green-400">R {fmt(nwResult.totalAssets, 0)}</p>
              </div>
              <div className="bg-background rounded-lg p-4 border border-red-500/30 text-center">
                ...
                <p className="font-mono text-lg font-bold text-red-400">R {fmt(nwResult.totalLiabilities, 0)}</p>
              </div>
              <div className={`rounded-lg p-4 border text-center ${nwResult.netWorth >= 0 ? "border-primary/30 bg-background" : "border-red-500/30 bg-red-500/10"}`}>
                ...
                <p className={`font-mono text-lg font-bold ${nwResult.netWorth >= 0 ? "text-primary" : "text-red-400"}`}>R {fmt(nwResult.netWorth, 0)}</p>
              </div>
            </div>
          )}
        </TabsContent>
          ...
          {fireResult && (
            <div className="grid grid-cols-3 gap-3">
              <div className="bg-background rounded-lg p-4 border border-border text-center">
                ...
                <p className="font-mono text-lg font-bold text-foreground">R {fmt(fireResult.fireNumber, 0)}</p>
              </div>
              ...
              <div className="bg-background rounded-lg p-4 border border-border text-center">
                ...
                <p className="font-mono text-lg font-bold text-foreground">R {fmt(fireResult.currentGap, 0)}</p>
              </div>
            </div>
          )}
        </TabsContent>
